var user={
		 useruuid:GetQueryString("useruuid") // || "f7791227-da5f-46d3-aee4-3cecaa3137f1"
};
if(!user.useruuid){
	alert("useruuid为空");
};
...
var httpUrl={
		...
		// 成长档案
        classList:path+"/app/mbtrack/search/user/classList", // 获取当前人所在班级
        studentList:path+"/app/mbtrack/search/class/studentList", // 获取班级的幼儿列表
        danList:path+"/app/mbtrack/child/danList", // 获取幼儿的档案列表
