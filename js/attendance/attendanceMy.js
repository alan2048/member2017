...
function attendanceList_port(json) {
    ...
    initAjax(httpUrl.attendMyCheckingRecord,param,attendanceList_callback,json);
};
...
function attendGetClassAttendanceInfo_port (today) {
    ...
    initAjax(httpUrl.attendMyLeaveRecord,param,attendMyLeaveRecord_callback,today);
};
    ...
    if(res.code==200){
        ...
        for(i in data){
            if(data[i].length !=0){
                ...
                switch (data[i][0].leaveIcon){
                    case "事":
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text(data[i][0].leaveIcon).addClass("active thing");
                        break;
                    case "病":
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text(data[i][0].leaveIcon).addClass("active sick");
                        break;
                    case "公":
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text(data[i][0].leaveIcon).addClass("active public");
                        break;
                    case "调":
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text(data[i][0].leaveIcon).addClass("active adjust");
                        break;
                    case "其":
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text(data[i][0].leaveIcon).addClass("active other");
                        break;
                    case "拒":
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text(data[i][0].leaveIcon).addClass("active refuse");
                        break;
                    default:
                        $(".sc-item:not(.sc-othermenth)[data-day="+i+"]").children(".lunar-day").text("").removeClass("active");
                };
            };
        };
        if(num ==0){
